	...
	$(".btn_brad").click(function()
		{
			if (!move1)
			{	
				$(".btn_brad").animate({"margin-top": '40%', "z-index": '1' }, 400);
				$(".btn_web, .btn_dgraf, .btn_mdig").animate({"margin-top": '150%'}, 400);
      ...
      duration:500
				...
				$(".btn_brad").animate({"margin-top": '150%'}, 400);
	...
	$(".btn_web").click(function()
		{
			if (!move2)
			{	
				$(".btn_web").animate({"margin-top": '40%', "z-index": '1'}, 400);
				$(".btn_brad, .btn_dgraf, .btn_mdig").animate({"margin-top": '150%'}, 400);
      ...
      duration:500
				...
				$(".btn_web").animate({"margin-top": '150%'}, 400);
	...
	$(".btn_dgraf").click(function()
		{
			if (!move3)
			{	
				$(".btn_dgraf").animate({"margin-top": '40%', "z-index": '1'}, 400);
				$(".btn_brad, .btn_web, .btn_mdig").animate({"margin-top": '150%'}, 400);
      ...
      duration:500
				...
				$(".btn_dgraf").animate({"margin-top": '150%'}, 400);
	...
	$(".btn_mdig").click(function()
		{
			if (!move4)
			{	
				$(".btn_mdig").animate({"margin-top": '40%', "z-index": '1'}, 400);
				$(".btn_brad, .btn_web, .btn_dgraf").animate({"margin-top": '150%'}, 400);
      ...
      duration:500
				...
				$(".btn_mdig").animate({"margin-top": '150%'}, 400);
